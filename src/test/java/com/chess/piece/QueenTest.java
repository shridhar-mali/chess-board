...
class QueenTest {
    ...
    void shouldReturnAllValidMovementsForPositionA1() {
        List<String> allValidMovements = queen.getAllValidMovements(board(), new Position("A1"));
    ...
    void shouldReturnAllValidMovementsForPositionD6() {
        List<String> allValidMovements = queen.getAllValidMovements(board(), new Position("D6"));
