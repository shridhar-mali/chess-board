...
class QueenTest {
    ...
    void shouldReturnAllValidMovementsForPositionA1() {
        Set<String> allValidMovements = queen.getAllValidMovements(board(), new Position("A1"));
    ...
    void shouldReturnAllValidMovementsForPositionD6() {
        Set<String> allValidMovements = queen.getAllValidMovements(board(), new Position("D6"));
